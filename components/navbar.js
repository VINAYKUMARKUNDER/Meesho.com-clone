const navbar = ()=>{
    return `
    <div id="leftNav">
        <div id="logoMeesho"><img src="https://etimg.etb2bimg.com/photo/86809724.cms" alt="WebsiteLogo"></div>
    ...
    <div id="RightNav">
        <ul>
            ...
            <a href="https://play.google.com/store/apps/details?id=com.meesho.supply"> <img src="https://images.meesho.com/images/pow/playstore-icon-big.webp"
            alt="android"> </a>
            <a href="https://play.google.com/store/apps/details?id=com.meesho.supply">  <img src="https://images.meesho.com/images/pow/appstore-icon-big.webp" alt="ios"></img> </a>
                 </div>
            </div>
         </a></li>
            ...
            <li><a href="./meesho2/Products/cart.html"> <i class="bi bi-cart"></i>Cart</a></li>
        </ul>
    </div>`
}
