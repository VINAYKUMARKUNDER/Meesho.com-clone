const content = ()=>{
    ...
    <div id="div1">
        ...
        <div id="a"> 
            ...
            <div id="playStoreButton"> 
                ...
                <a href="https://play.google.com/store/apps/details?id=com.meesho.supply&pid=pow_website&c=pow&pow_click_page_type=HP&pow_distinct_id=17f0cd4777b117-04320a26165079-a3e3164-100200-17f0cd4777c3c" > 
                    <div>
                    <img src="https://i.pinimg.com/originals/60/a8/b5/60a8b504a19449659ac8e41d3fb807a4.gif" alt="play" >
                </div>
                <div>
        ...
        <div id="b">
            <img src="https://images.meesho.com/images/marketing/1631722939962.jpg" alt="err"/>
        </div>
    ...
    <div id="div2">
        <div id="leftDiv2">
            <img class="img2" src="https://images.meesho.com/images/marketing/1631611172021.png" alt="fail"> 
        </div>
        <div id="rightDiv2">
            <div id="single">
                Fashion Store
            </div>
            <div id="double"> <img src="https://images.meesho.com/images/marketing/1631610854491.png" alt="fail">
                <img src="https://images.meesho.com/images/marketing/1631611208025.png" alt="fail">
            </div>
        </div>
    ...
    <div id="homecare">
        <div>
            <div>
                <h1>Homecare</h1><button>VIEW ALL</button>
            </div>

            <div><img src="https://images.meesho.com/images/marketing/1629883981751.png" alt="bedsheet">
                <button>Bedsheets</button>
            </div>
            <div><img src="https://images.meesho.com/images/marketing/1629884011960.png" alt="Kitchenware">
                <button>Kitchenware</button>
            </div>
            <div><img src="https://images.meesho.com/images/marketing/1629883997863.png" alt="Carpets">
    ...
    <div class="reseller" >
        ...
        <div class="android">
            <img src="https://images.meesho.com/images/pow/playstore-icon-big.webp"
                alt="android">
            <img src="https://images.meesho.com/images/pow/appstoreIcon.webp" alt="ios">
        </div>
    ...
    <div class="last">
        ...
        <div>
            <div> <img
                    ...
                    alt="">
                Grow your business 10x</div>

            <div> <img
                    src="data:image/svg+xml;base64,"
                    alt="">
                Enjoy 100% Profit</div>
            <div> <img
                    src="data:image/svg+xml;base64,"
                    alt="">
                Sell all over India</div>
        </div>
